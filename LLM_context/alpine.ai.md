...
3. [Core Concepts: State and Reactivity](#core-concepts-state-and-reactivity)
4. [Conditional Display](#conditional-display)
5. [Event Handling](#event-handling)
   - [Mouse Events](#mouse-events)
   - [Keyboard Events](#keyboard-events)
   - [Event Modifiers](#event-modifiers)
6. [The Big Difference: Backend Integration with Server-Sent Events (SSE)](#the-big-difference-backend-integration-with-server-sent-events-sse)
