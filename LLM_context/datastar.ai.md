...
4. [Frontend Reactivity](#frontend-reactivity)
   - [Signals and State Management](#signals-and-state-management)
   - [Two-way Data Binding](#two-way-data-binding)
   - [Computed Properties](#computed-properties)
   - [Conditional Rendering](#conditional-rendering)
   - [Class and Attribute Binding](#class-and-attribute-binding)
...
7. [Building UI Components](#building-ui-components)
   - [Forms](#forms)
   - [Dropdowns](#dropdowns)
   - [Tabs](#tabs)
   - [Modals](#modals)
8. [Advanced Techniques](#advanced-techniques)
   - [Dynamic DOM Updates](#dynamic-dom-updates)
   - [Batch Operations](#batch-operations)
   - [Working with Custom Events](#working-with-custom-events)
   - [Integration with JavaScript Libraries](#integration-with-javascript-libraries)
9. [Best Practices](#best-practices)
10. [Troubleshooting](#troubleshooting)
11. [Conclusion](#conclusion)
12. [Important Naming Convention](#important-naming-convention)
...
Signals are reactive variables that automatically track and propagate changes. When a signal's value changes, any part of the UI that depends on that signal automatically updates. Signals are created with `data-bind`, `data-signals`, or `data-computed` attributes.
...
Include Datastar in your HTML using the CDN:
